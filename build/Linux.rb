...
def commands
  [
    ...
    sys("sudo dnf install -y https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-#{`rpm -E %fedora`.chomp}.noarch.rpm", !File.exist?("/etc/yum.repos.d/rpmfusion-nonfree.repo")),
